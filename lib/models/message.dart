...
class Message {
  ...
  const Message(
      {this.messageSentTo, this.messageSentBy, this.message, this.date,});
  ...
  Message copyWith(
      ...
      String? lastMassage,}) {
    return Message(
      messageSentTo: messageSentTo ?? this.messageSentTo,
      messageSentBy: messageSentBy ?? this.messageSentBy,
